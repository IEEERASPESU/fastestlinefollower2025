...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : AENEABLE_Pin BENABLE2_Pin SENSOR10_Pin SENSOR11_Pin
                           SENSOR12_Pin SENSOR13_Pin */
  GPIO_InitStruct.Pin = AENEABLE_Pin|BENABLE2_Pin|SENSOR10_Pin|SENSOR11_Pin
                          |SENSOR12_Pin|SENSOR13_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : SENSOR14_Pin SENSOR1_Pin SENSOR2_Pin SENSOR3_Pin
                           ...
                           SENSOR8_Pin DIP1_Pin DIP2_Pin DIP4_Pin */
