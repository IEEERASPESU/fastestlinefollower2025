...
#define BENEABLE2_Pin GPIO_PIN_7
#define BENEABLE2_GPIO_Port GPIOA
#define BENEABLE_Pin GPIO_PIN_4
#define BENEABLE_GPIO_Port GPIOC
...
#define AENEABLE2_Pin GPIO_PIN_9
#define AENEABLE2_GPIO_Port GPIOB
